...
const FR = {
  ...
  'aide.controles.texte':
    'Flèches ou ZQSD pour marcher. Entrée ou E pour parler, lire un panneau, ramasser. Échap ou M ouvre le menu. À la souris : cliquez une case pour vous y rendre, quelqu’un pour aller lui parler, une ligne pour la choisir. Sur téléphone, les boutons à l’écran font la même chose.',
  ...
  'sauvegarde.exporter': 'Exporter la partie',
  'sauvegarde.importer': 'Importer une partie',
  'sauvegarde.exporterCreature': 'Exporter une créature',
  'sauvegarde.importerCreature': 'Importer une créature',
  'sauvegarde.exporterQui': 'Exporter quelle créature ?',
  ...
  'sauvegarde.mauvaisFichier': 'Ce fichier n’entre pas par ici : passez par « {entree} ».',
  ...
  // document — `equipe[0].moves[0].id` — et ne se traduit donc pas.
  'sauvegarde.motif.objet': '{chemin} devrait être un objet',
  'sauvegarde.motif.liste': '{chemin} devrait être une liste',
  'sauvegarde.motif.texte': '{chemin} devrait être du texte',
  'sauvegarde.motif.tropLong': '{chemin} dépasse {max} caractères',
  'sauvegarde.motif.nombre': '{chemin} devrait être un nombre',
  'sauvegarde.motif.intervalle': '{chemin} devrait être entre {min} et {max}',
  'sauvegarde.motif.inconnue': '{chemin} : valeur inconnue « {valeur} »',
  'sauvegarde.motif.tropDEntrees': '{chemin} contient trop d’entrées',
  'sauvegarde.motif.attaquesVides': '{chemin}.moves ne peut pas être vide',
  'sauvegarde.motif.attaquesTrop': '{chemin}.moves dépasse quatre attaques',
  'sauvegarde.motif.adversairesVides': 'combat.adversaires ne peut pas être vide',
  'sauvegarde.motif.adversairesTrop': 'combat.adversaires dépasse six créatures',
  'sauvegarde.motif.adversaireKo': 'l’adversaire en jeu est hors de combat',
  'sauvegarde.motif.creatureKo': 'la créature en jeu est hors de combat',
  'sauvegarde.motif.mauvaisFormat': 'ce fichier n’est pas un document « {format} »',
  'sauvegarde.motif.versionFuture': 'il vient d’une version plus récente du jeu (v{version})',
  'sauvegarde.motif.equipeVide': 'l’équipe est vide',
  'sauvegarde.motif.equipeTrop': 'l’équipe dépasse six créatures',
  'sauvegarde.motif.reserveTrop': 'la réserve dépasse trois cents créatures',
  'sauvegarde.motif.uidDouble': 'deux créatures partagent l’identifiant « {uid} »',
  'sauvegarde.motif.checksum': 'somme de contrôle incorrecte',
  'sauvegarde.motif.combatAbandonne': 'combat en cours abandonné',
  'sauvegarde.motif.jsonInvalide': 'ce n’est pas du JSON valide',

  // Étiquette du canvas pour les lecteurs d'écran.
  'a11y.canvas': 'Fenêtre de jeu Terravia',
  'boot.echec': 'Terravia n’a pas pu démarrer.',
  ...
  // Le gabarit porte l'ordre des mots : « Mulotin adverse » en français, « Foe Mulotin »
  // en anglais. Une concaténation dans le code n'aurait su en dire qu'un des deux.
  'combat.adverse': '{nom} adverse',
  ...
  'combat.talent': 'Son talent {talent} se déclenche.',
...
const EN: Record<CleTexte, string> = {
  ...
  'aide.controles.texte':
    'Arrows or WASD to walk. Enter or E to talk, read a sign, pick things up. Escape or M opens the menu. With a mouse: click a tile to walk there, click someone to go and talk to them, click a row to pick it. On a phone, the on-screen buttons do the same.',
  ...
  'sauvegarde.exporter': 'Export the game',
  'sauvegarde.importer': 'Import a game',
  'sauvegarde.exporterCreature': 'Export a creature',
  'sauvegarde.importerCreature': 'Import a creature',
  'sauvegarde.exporterQui': 'Export which creature?',
  ...
  'sauvegarde.mauvaisFichier': 'This file does not come in here: use {entree} instead.',
  ...
  'sauvegarde.motif.liste': '{chemin} should be a list',
  'sauvegarde.motif.texte': '{chemin} should be text',
  'sauvegarde.motif.tropLong': '{chemin} is longer than {max} characters',
  'sauvegarde.motif.nombre': '{chemin} should be a number',
  'sauvegarde.motif.intervalle': '{chemin} should be between {min} and {max}',
  'sauvegarde.motif.inconnue': '{chemin}: unknown value « {valeur} »',
  'sauvegarde.motif.tropDEntrees': '{chemin} holds too many entries',
  'sauvegarde.motif.attaquesVides': '{chemin}.moves cannot be empty',
  'sauvegarde.motif.attaquesTrop': '{chemin}.moves holds more than four moves',
  'sauvegarde.motif.adversairesVides': 'combat.adversaires cannot be empty',
  'sauvegarde.motif.adversairesTrop': 'combat.adversaires holds more than six creatures',
  'sauvegarde.motif.adversaireKo': 'the opposing creature is already out of the fight',
  'sauvegarde.motif.creatureKo': 'the creature in play is out of the fight',
  'sauvegarde.motif.mauvaisFormat': 'this file is not a « {format} » document',
  'sauvegarde.motif.versionFuture': 'it comes from a newer version of the game (v{version})',
  'sauvegarde.motif.equipeVide': 'the team is empty',
  'sauvegarde.motif.equipeTrop': 'the team holds more than six creatures',
  'sauvegarde.motif.reserveTrop': 'storage holds more than three hundred creatures',
  'sauvegarde.motif.uidDouble': 'two creatures share the identifier « {uid} »',
  'sauvegarde.motif.checksum': 'checksum mismatch',
  'sauvegarde.motif.combatAbandonne': 'the battle in progress was dropped',
  'sauvegarde.motif.jsonInvalide': 'this is not valid JSON',

  'a11y.canvas': 'Terravia game window',
  'boot.echec': 'Terravia could not start.',
  ...
  'combat.talent': 'Its {talent} talent kicks in.',
